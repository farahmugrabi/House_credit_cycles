...
- I have uploaded the data used in the paper, see data.full.csv (I think one quarter after the working paper publication, so it might have one additional quarter. I understand there will be mayor revisions in the outanding credit provided to households, so I want to store the original series used in the paper. If you run this code again the R script (data.R), you will overwritte this file uploading data with APIs.
